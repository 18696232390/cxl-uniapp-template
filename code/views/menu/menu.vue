<template>
	<view class="u-wrap">
		<u-navbar :is-back="false" title="菜单"></u-navbar>
				...
				<view class="page-view">
					<view class="class-item" :id="'item' + index" v-for="(item , index) in tabbar" :key="index" >
						...
						<view class="item-container">
							<view class="thumb-box" v-for="(item1, index1) in item.foods" :key="index1" @tap="doOpenMenuPage(item1)">
		...
		methods: {
			...
			async doOpenMenuPage(item){
				...
				if(item.name === '答案之书'){
					...
					this.$appPush(params)
					uni.navigateTo({
						url:'/views/module/game/answersBook/answersBook'
					})
				}else {
					uni.showToast({
						icon:'none',
